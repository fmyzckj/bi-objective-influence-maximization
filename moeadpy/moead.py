...
class MOEAD(object):
    ...
    def __init__(self, population, toolbox, mu, cxpb, mutpb, nodes, ngen=0, maxEvaluations=0,
    ...
    def execute(self):
        ...
        count = 0
        f = open("Moead"+str(self.Nodes)+"each1generation.txt", "a")
        ...
        while self.evaluations_ < self.maxEvaluations:
            ...
            func = [self.toolbox.evaluate(i) for i in self.paretoFront]
