...
class Evolution:
    ...
    def __init__(self, problem, Nodes ,num_of_generations=1000, num_of_individuals=100, num_of_tour_particips=2, tournament_prob=0.9):
        self.utils = NSGA2Utils(problem, Nodes, num_of_individuals, num_of_tour_particips, tournament_prob)
    ...
    def evolve(self):
        ...
        f = open("NSGAII"+str(self.Nodes)+"each1generation.txt", "a")
